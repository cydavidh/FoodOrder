                ...
                <div class="page-title-wrapper text-center">
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="page-title-inner">
                            <h1 itemprop="headline">Confirm Your Address</h1>
                                        ...
                                        <div class="col-md-3 col-sm-12 col-lg-3">
                                            <div class="reservation-tabs-list brd-rd5">
                                                <ul class="nav nav-tabs brd-rd5">
                                                    <li class="active">
														<a href="#reservation-tab1">
														<span class="brd-rd50">1</span> Information</a>
													</li>
                                                    <li>
														<a href="#reservation-tab2">
															<span class="brd-rd50">✔</span>Order Successfully
														</a>
													</li>
                                                </ul>
                                            </div>
                                                        ...
                                                        <form class="restaurant-info-form brd-rd5">
                                                            <div class="row mrg20">
                                                                ...
                                                                <div class="col-md-12 col-sm-6 col-lg-12">
                                                                    <label>Delivery/Pickup <sup>*</sup></label>
                                                                    <div class="select-wrp">
                                                                        <select>
                                                                ...
                                                                <div class="col-md-12 col-sm-12 col-lg-12">
                                                                    <div class="step-buttons">
                                                                        <a class="brd-rd3 red-bg" href="#" title="" itemprop="url">Next Step</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
